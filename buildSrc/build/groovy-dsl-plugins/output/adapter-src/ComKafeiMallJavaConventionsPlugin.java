...
/**
 * Precompiled com.kafei.mall.java-conventions script plugin.
 **/
public class ComKafeiMallJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComKafeiMallJavaConventions").asSubclass(BasicScript.class);
