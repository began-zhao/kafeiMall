...
import com.kafeimall.product.repo.repository.converter.CategoryConverter;
...
public class CategoryRepository {
    ...
    public List<ProductCategory> getProductCategory() {
        ...
        List<ProductCategory> productCategories = categoryPOS.stream().map(e -> {
            ProductCategory productCategory = CategoryConverter.INSTANCE.toProductCategoryDO(e);
